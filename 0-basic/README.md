...
| 详细实验步骤 | 1. 安装MetaMask钱包，创建钱包账户，备份助记词与私钥，理解私钥-公钥-地址的映射关系<br>2. 配置Sepolia测试网，通过水龙头获取测试网ETH，https://cloud.google.com/application/web3/faucet/ethereum/sepolia<br>3. 发起一笔测试网转账交易，设置Gas Limit与Gas Price，观察交易打包过程<br>4. 在Etherscan中查询该笔交易，解析交易的核心字段（Block Number、Nonce、From/To、Value、Gas Used、Input Data）<br>5. 对比交易打包前后的账户余额变化，理解Gas手续费的扣除逻辑 |
